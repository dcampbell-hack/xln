...
import getUniqArr from '../../middleware/getUniqueArr.ts';
...
//@access Public 
export const getTransaction = asyncHandler(async (req: Request, res: AdvanceResults, next: NextFunction) => {
...
//@access Public 
export const getTransactions = asyncHandler(async (req: Request, res: AdvanceResults, next: NextFunction) => {
...
//@route GET /api/v1/shares/:shareId/tx
//@access Public 
export const createTransaction = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction) => {
