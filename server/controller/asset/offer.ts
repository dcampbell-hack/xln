...
import { RequestWithArgs, AdvanceResults, IUserAuthRequest } from '../../type/definition.ts';
...
//@access Public 
export const getOffer = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
...
//@access Public 
export const getOffers = asyncHandler(async (req: RequestWithArgs, res: AdvanceResults, next: NextFunction) => {    
...
//@access Public 
export const createOfferDirect = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction) => {
...
//@access Public 
export const createOfferResell = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction) => {
...
//@route GET /api/v1/offers/:id
//@access Public 
export const respondOffer = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction) => {
...
if(req.user.id !== offer.assetOwner){
    return next(`Not auhtorized to respond to another user's offer.`)
}
...
//@route GET /api/v1/offers/:id 
//@access Public 
export const deleteOffer = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction) => {
    const offer = await Offer.findById(req.params.id);
    if(!offer){
        return next(new ErrorResponse(`No offer with the id of ${req.params.id}`, 404))
    }
