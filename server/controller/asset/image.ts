...
//@access Public 
export const getImage = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
...
//@access Public 
export const getImages = asyncHandler(async (req: Request, res: AdvanceResults, next: NextFunction) => {
...
//@access Public 
export const createImage = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction) => {
...
//@route GET /api/v1/images/:id
//@access Public 
export const updateImage = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction) => {
...
//@route GET /api/v1/images/:id 
//@access Public 
export const deleteImage = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction) => {
    const image = await Image.findById(req.params.id);
    if(!image){
