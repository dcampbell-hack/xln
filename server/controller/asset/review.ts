...
//@access Public 
export const getReviews = asyncHandler(async (req: Request, res: AdvanceResults, next: NextFunction) => {
...
//@access Public 
export const addReview = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction) => {
