...
// Local
import { IUserAuthRequest } from '../../type/definition.js'
...
//@access Public 
export const register = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction) => {
...
//@access Public 
export const login = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction) => {
...
//@access Private 
export const logout = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction) => {
...
//@access PRIVATE
export const username = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction) => {
...
//@ access Private 
export const updatePassword = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction) => {
    // Get User 
...
//@access Public 
export const forgotPassword = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction) => {
...
//@access Public 
export const resetPassword = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction) => {
    //Get hashed token
...
//@access Private 
export const updateDetails = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction) => {
