...
import { IUserAuthRequest, AdvanceResults } from '../../type/definition.js'
...
export const getUsers = asyncHandler(async (req: IUserAuthRequest, res: AdvanceResults, next: NextFunction ) => {
...
//@access PUBLIC
export const getUser = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction ) => {
...
//@access PRIVATE
export const createUser = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction ) => {
...
//@access PRIVATE
export const updateUser = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction ) => {
...
//@access Private/Admin
export const deleteUser = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction ) => {
...
//@access Private
export const updateUserAvatar = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction ) => {
...
//@access Private
export const updateUserCover = asyncHandler(async (req: IUserAuthRequest, res: Response, next: NextFunction ) => {
