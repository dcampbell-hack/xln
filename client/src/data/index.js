...
import { AddPermissions } from "../components/utils/layout/template/elements/layoutStyles";
     ...
     sections: [
       {
         ...
         content: {
           ...
           lists: [
             {
               label: "Blockchain",
               isArray: false,
               content: "A system in which a record of transactions is made in cryptocurrency and is maintained across several computers that are linked in a peer-to-peer network."
             },
             {
           ...
           },
           {
            ...
            isArray: false,
            content: "IPFS is a peer-to-peer (p2p) storage network. Content is accessible through peers located anywhere in the world, who might relay information, store it, or do both. IPFS knows how to find what you ask for using its content address rather than its location."
          },
          {
            label: "Artificial Intelligence (AI)",
            isArray: false,
            content: "The theory and development of computer systems able to perform tasks that normally require human intelligence, such as visual perception, speech recognition, decision-making, and translation between languages."
          },
          {
            label: "The Metaverse",
            isArray: false,
            content: "A virtual-reality space in which users can interact with a computer-generated environment and other users."
          },
           ]
         }
       },
        ...
        content: {
          ...
          lists: [
            ...
            },
            {
              label: "Data ownership",
              isArray: false,
              content: "Medallion XLN aims to provide our decentralized community with the ability to own and monetize every aspect of their data. Tools are built to provide full control over who can access this data and how it will be shared, and if other users can collaborate with that data. Web2 was defined by what Tech Companies could do with your data, Medallion XLN will define Web3 by what each person can do with their data."
            },
            {
              label: "Monetization",
              isArray: false,
              ...
              content: [
                {
                  ...
                  type: "team",
                  content: [
                    "Dwayne Campbell, Chief Executive Officer CEO will define Medallion XLN’s overall vision, technology, user & client acquisition strategy. Dwayne will work with Executives to build each department most optimally and has the final say on all major company decisions. Dwayne manages the Executives and is responsible for providing them with the information and resources they need to best run their departments. Dwayne has over a decade of experience as a serial entrepreneur and senior software developer at various technology organizations and has been working on the vision for Medallion XLN for 5 years.", "Compensation: $250,000 + 20% of Founders portion in ICO Manages access to Executive Initiatives & all company funds"
                  ]
                },
                {
                  image: COO,
                  type: "team",
                  content: ["Allan, Chief Operation Officer (COO) receives the vision of the CEO and breaks them down into strategic achievable goals. Allan will be involved in all aspects of the company’s operation and will build constructs to improve the efficiency of each department. Allan has over 3 decades of experience working in the financial industry. His perspective will be key in building the infrastructure needed for our startup to IPO.", "Compensation: $240,000 + 10% of Founders portion in ICO Co-manages access to Operations fund with CEO"]
                },
                {
                  image: XPO,
                  type: "team",
                  content: ["Ana Guilbert, Executive Program Officer (XPO) oversees the planning and implementation of the entire organization. Ana’s responsibilities include budgeting, hiring team members for each department, sourcing suppliers, and planning each product release.", "Compensation: $240,000 + 10% of Founders portion in ICO Co-manages access to Programs fund with CEO"]
                },
                {
                  image: CTO,
                  type: "team",
                  content: ["GK, Chief Technology Officer (CTO) Meet GK our CTO | ex PayPal, ex eBay, he has more than a decade of experience in building core technologies and shipping stellar user experiences to millions of users. GK holds a BS and MS degrees in Computer Science. Based out of San Francisco Bay Area, when he is not in a Nerd mode, he spends time with his friends and family. GK leads the technology & engineering department. GK develops policies & procedures that allow our company to scale exponentially on mobile, web & XR platforms. His department will be building tools for both internal and external use. Gaurav has been a lead engineer at top payment companies such as eBay, Paypal & Venmo for over 15 years.", "Compensation: [salary TBA] + 19% of Founders portion in ICO Co-manages access to Technology fund with CEO"]
                },
                {
                  image: CBO,
                  type: "team",
                  content: ["Chief Blockchain Officer (CBO) works under the CTO to carve out a strategy for Medallion XLN’s token, smart contracts & blockchain. Seeking a visionary to fill this role. Someone that can predict emerging trends and position Medallion XLN to reap the rewards before our competition."]
                },
                {
                  image: CAO,
                  type: "team",
                  content: ["Gary Robinson, Chief Acquisitions Officer (CAO) leads the client acquisitions department and will be the first friendly face company that extends Medallion XLN’s features will interact with. Gary is responsible for leading a department that onboards as many companies as possible & maintaining that relationship. Gary has been a sales & customer service specialist for over 30 years.", "Compensation: $240,000 + 10% of Founders portion in ICO Co-manages access to Acquisitions fund with CEO"]
                },
                {
                  image: XRO,
                  type: "team",
                  content: ["Ptah “ArtCrazy” Quammie, Extended Reality Officer (XRO), Head photographer Ptah Quammie established ArtCrazy Photography in the early summer of 2010. Since then ArtCrazy has expanded its reach to Las Vegas, Miami, New York, California, the Caribbean, and abroad, to produce some of the most innovative concepts in photography. While providing a full range of photography needs, ArtCrazy and its affiliates have expanded to provide a full spectrum of media production including professional video and editing services. ArtCrazy specializes particularly in fashion editorial, artistic nudes, swimsuits, and portfolio development. Whether you are a newcomer to modeling or a seasoned vet, ArtCrazy will reshape and redefine you. Medallion XLN’s main selling point is asset ownership. XRO will work with CTO to design a Metaverse concept that allows various user-owned assets to be integrated into a Metaverse space."]
                },
                {
                  image: CMO,
                  type: "team",
                  content: [ "Chief Marketing Officer (CMO) Kushner Sophia, an American entrepreneur who was born and raised in Canada, I am one of many entrepreneurs who has taken her talents to the digital space by minting and selling non-fungible tokens, or NFTs, on digital marketplaces. Before minting and selling non- fungible tokens I also have a career in crypto where back in 2020 I started my ROI (Return on investments) the success rate was 90% for myself and others who invested and has moved further up to hold coins on Public. Kushner Sophia is a principal body under Arenalive a United Kingdom-based company charged with promoting economic programs and national public-private partnerships to advance innovation and entrepreneurship."]
                }
              ]
            }
          ]
        ...
        content: {
          ...
          lists: [
            ...
            },
            {
              label: "Beyond",
              isArray: false,
              content: "Medallion XLN will extend its use case to critical infrastructure such as roads, bridges, dams, airports and more that will receive tolls to run completely autonomously. In this phase, we aim to be a stealth layer 1 that processes all transactions. Reaching a Type-2 civilization needs a scalable solution. Space colonies the size of Texas need to be stabilized away from Earth’s orbit. We will develop an industrial 3D printer that gathers the surrounded space dust. It will use Machine Learning to categorize the various elements then remotely print the entire space station. The 3D printer would need to know how to self replicate. We need about a 1000 between each planet so that spaceships can dock, run diagnostics checks and rest. We spread these colonies through out the entire solar system then harness the energy from the entire solar system. Then we begin our plan for Type-3. Medallion XLN is the future!"
            },
          ]
        }
      },
