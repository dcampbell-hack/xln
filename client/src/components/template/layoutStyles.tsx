...
import Avatar from "../utils/avatar/index.jsx";
import { AssetItem } from "../utils/asset/assetItem.jsx";
import { PrimaryB, InfoB, WarningB, DangerB } from "../utils/buttons/buttons.js";
import { DangerL, LinkL, PrimaryL, InfoL } from "../utils/buttons/links.js";
import TruncateText from "../utils/text/truncate.js";
import FormatLayout from "../layout/index.js";
import AllCameras from "../utils/webcam/AllCameras.jsx";
import { timeSince } from "../utils/operations/calculations.js";


export const AvatarProfile: React.FC = ({ options: {}, setActionType }) => {
  return (
    <div>
...
export const CodeBlock: React.FC = ({ options: {}, setActionType }) => {
  return (
    <div>
      <h2>Code Block</h2>
    </div>
...
export const FileUpload: React.FC = ({ className, id, name }) => (
...
export const ShowAsset: React.FC = ({
  blockchain,
  assets: { asset },
...
export const ShowAssets: React.FC = ({
  collection,
...
export const ShowComments: React.FC = ({ options: {}, setActionType }) => {
  return (
    <div>
      <h2>ShowComments</h2>
      <p>
...
export const ShowReviews: React.FC = ({ options: {}, setActionType }) => {
  return <div>Show Reviews</div>;
};


export const TestFuncsTemplate: React.FC = ({ options: { buttons }, setActionType }) => {
